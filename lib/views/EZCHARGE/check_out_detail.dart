...
import 'package:ezcharge/views/ezcharge/check_out_success_screen.dart';
  ...
  Future<void> _handleCheckOut(durationString, totalAmount) async {
    ...
    try {
      ...
      await FirebaseFirestore.instance
          ...
          .set({
            "CheckInTime":
                _startTime, // Assuming _startTime is already a Timestamp
            ...
            "TotalCost": double.parse(
              (totalAmount + _penalty).toStringAsFixed(2),
            ),
          });
      await FirebaseFirestore.instance
          .collection("station")
