...
class _EditAdminProfileScreenState extends State<EditAdminProfileScreen> {
  ...
  String? _adminId; // Stores the Firestore CustomerID
  ...
  void initState() {
    super.initState();
    _fetchAdminData(); // Fetch Firestore data when screen loads
  }
    ...
    try {
      ...
      if (user != null) {
        ...
        if (querySnapshot.docs.isNotEmpty) {
          ...
          setState(() {
            _adminId = userDoc["AdminID"]; // Store AdminID for updating later
